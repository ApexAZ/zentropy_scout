...
| 6 | **Audit stretch weights, quality & batch** — `test_stretch_score_weights`, `test_quality_metrics`, `test_non_negotiables_filter`, `test_batch_scoring` (4 files) | `plan, test` | ⬜ |
