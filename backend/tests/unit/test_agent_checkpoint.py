...
class TestCreateGraphConfig:
    ...
    def test_config_has_thread_id(self) -> None:
    ...
    def test_config_includes_user_id(self) -> None:
...
class TestRequestHumanInput:
    ...
    def test_sets_requires_human_input_flag(self) -> None:
    ...
    def test_sets_checkpoint_reason(self) -> None:
...
class TestResumeFromCheckpoint:
    ...
    def test_clears_requires_human_input_flag(self) -> None:
    ...
    def test_clears_checkpoint_reason(self) -> None:
    ...
    def test_adds_user_response_to_messages(self) -> None:
    ...
    def test_sets_current_message(self) -> None:
