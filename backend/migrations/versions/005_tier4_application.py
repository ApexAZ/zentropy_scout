...
down_revision: str | None = "004_tier3_deeper_fk"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        # Status tracking
        sa.Column(
            "status", sa.String(20), nullable=False, server_default=sa.text("'Applied'")
        ),
        ...
        sa.ForeignKeyConstraint(
            ["job_variant_id"], ["job_variants.id"], ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(
            ["cover_letter_id"], ["cover_letters.id"], ondelete="SET NULL"
        ),
        # Check constraints
        sa.CheckConstraint(
    ...
    op.create_table(
        ...
        sa.Column(
            "application_id", sa.UUID(), nullable=True
        ),  # NULL until user marks "Applied"
        sa.Column("resume_source_type", sa.String(20), nullable=False),
        sa.Column(
            "resume_source_id", sa.UUID(), nullable=False
        ),  # App-enforced FK to Base or Variant
        sa.Column("file_name", sa.String(255), nullable=False),
        sa.Column(
            "file_binary", sa.LargeBinary(), nullable=False
        ),  # BYTEA - actual PDF
        sa.Column(
            "generated_at",
            sa.DateTime(timezone=True),
    ...
    op.create_table(
        ...
        # Foreign keys
        sa.ForeignKeyConstraint(
            ["cover_letter_id"], ["cover_letters.id"], ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(
            ["application_id"], ["applications.id"], ondelete="SET NULL"
        ),
...
def downgrade() -> None:
    ...
    op.drop_constraint(
        "fk_application_submitted_coverletter", "applications", type_="foreignkey"
    )
    op.drop_constraint(
        "fk_application_submitted_resume", "applications", type_="foreignkey"
    )
    ...
    op.drop_constraint(
        "fk_coverletter_application", "cover_letters", type_="foreignkey"
    )
