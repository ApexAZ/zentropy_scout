...
async function renderWithContent() {
	setupMockApi({ data: makeResume({ markdown_content: MARKDOWN_CONTENT }) });
	renderDetail();
	await waitFor(() => {
...
async function renderWithoutContent() {
	setupMockApi({ data: makeResume({ markdown_content: null }) });
	renderDetail();
	await waitFor(() => {
