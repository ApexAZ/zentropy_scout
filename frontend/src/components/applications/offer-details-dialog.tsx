...
export function OfferDetailsDialog({
	...
	return (
		<FormAlertDialog
			...
			title="Offer Details"
			description="Capture offer details. All fields are optional."
			loading={loading}
		...
		>
			...
			<div className="grid grid-cols-2 gap-4">
				...
				<div className={FIELD_WRAPPER_CLASS}>
					...
					>
						<SelectTrigger id="offer-currency" data-testid="currency-select">
							<SelectValue />
						</SelectTrigger>
						<SelectContent>
							{CURRENCIES.map((c) => (
				...
				<div className={FIELD_WRAPPER_CLASS}>
					...
					<Input
						...
						onChange={(e) => updateString("response_deadline", e.target.value)}
					/>
				</div>
			</div>
